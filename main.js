class Main {
    constructor(){
        // Creating the buttons on the main screen
        ...
        // Button sound on clicking
        this.buttonSound = loadSound('Button-click-sound.mp3');

        // Home button
        this.resetButton = createButton('🏠');

        // Buttons for scrolling through the safety tips
        this.tips2button = createButton('⨠');
        this.tips3button = createButton('⨠');

        // Button for scrolling throught the self defence
        ...
        // Calling the police and searching for nearby police stations
        this.policestation = createA('https://www.google.co.in/maps/search/nearby+police+station','Nearby Police Stations');
        this.policecall = createA("tel:100",'Call Police');
        this.otherno = createButton(' Other  <br> Numbers');

        // Other emergency numbers
        this.womencall = createA("tel:1091",'📞');
        this.emergencycall = createA("tel:112",'📞');
        this.ncwcall = createA("tel:011 2694 4805",'📞');
        this.ambulancecall = createA("tel:102",'📞');

        // Buttons for scrolling through the escaping threat tips
        ...
        this.videomy = createVideo('rakshavideo.mp4');
    ...
    display(){
        ...
        // Formatting the sfety tips buttons
        ...
        // Formatting the women laws button    
        ...
        // Formatting the escaping threat tips buttons
        ...
        // Formatting the self defence buttons and the videos
        ...
        // Formatting the SOS Alert button, the links to call various emergency numbers and the police station link   
        ...
        // Formatting the information button and the intro video about the app    
        this.infoButton.style('border-radius','80%');
        this.infoButton.style('font-size','15px');
        this.infoButton.position(320,677);

            this.videomy.hide();
            this.videomy.size(340,280);
            this.videomy.position(5,400);


        // Formatting the home button
        ...
        // Functions to click on the tips buttons
        ...
        // Function to click on the laws button   
        ...
        // Functions to click on the escape threat buttons
        ...
        // Functions to click on the self defence buttons
        ...
        // Functions to click on the SOS and the other numbers button  
        ...
        // Function to click on the information button   
        ...
        // Function to click on the home button to reset
